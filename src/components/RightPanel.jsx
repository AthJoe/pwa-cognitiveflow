export default function RightPanel({
  items = [],
  onMessagesClick = () => {}, // NEW: callback prop for Messages button
}) {
  return (
      ...
      <div className="pt-6 flex items-center gap-5">
        ...
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5 text-white">
            <path
              fill="currentColor"
              d="M12 5v6m3-3H9m11 9a2 2 0 01-2 2H6a2 2 0 01-2-2v-1c0-2.21 3.58-4 8-4s8 1.79 8 4v1zM16 7a4 4 0 11-8 0 4 4 0 018 0z"
            />
          </svg>
        </button>
